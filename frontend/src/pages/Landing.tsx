...
const testimonials = [
  { text: 'Excelente servicio, mi auto quedó impecable. La atención fue rápida y profesional. Muy recomendado.', author: 'María García', role: 'Cliente frecuente' },
  { text: 'La mejor experiencia de lavado que he tenido. Agendar fue muy fácil y cumplieron con el horario puntualmente.', author: 'Carlos López', role: 'Cliente' },
  { text: 'Desde que uso Monkey Auto Spa, mi coche siempre luce como nuevo. El personal es muy capacitado y amable.', author: 'Ana Martínez', role: 'Cliente frecuente' },
  { text: 'Precios justos y excelente calidad. La página es muy fácil de usar y puedes agendar en minutos.', author: 'Roberto Sánchez', role: 'Cliente' },
];
